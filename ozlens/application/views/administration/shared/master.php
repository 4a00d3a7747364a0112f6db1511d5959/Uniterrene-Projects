                        ...
                        <td colspan="2">
                            <?PHP if($this->session->userdata('loggedinuser')){?>
                                <ul id="menu" style="float:left;">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>administration/inquiries">&raquo; Inquiries</a></li>
                                    ...
                                    <li><a href="<?php echo base_url(); ?>administration/orders/report">&raquo; Report</a></li>
                        ...
                        <td colspan="2">
                            <?PHP if($this->session->userdata('loggedinuser')){?>
                                <ul id="menu" style="float:left;">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>administration/globalcoupon">&raquo; Global Discount Coupon</a></li>
                                    <li><a href="<?php echo base_url(); ?>administration/accountsettings">&raquo; Settings</a></li>
