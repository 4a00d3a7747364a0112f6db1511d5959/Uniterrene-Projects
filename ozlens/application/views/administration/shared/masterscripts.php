...
<script src="<?PHP echo base_url();?>assets/validationscriptfiles/lib/jquery.validate.js" type="text/javascript"></script>
...
<script>var cb = jQuery.noConflict();</script>
<!-- /End Color Box-->

<!-- Admin master js-->
<script src="<?PHP echo base_url()?>assets/js/admin_master.js"></script>
<!-- End admin master js-->
