...
function initDataTables(){	
 ...
 $('#example').dataTable( {
		...
		"aoColumns": [					
						...
						{ "sWidth": "auto" },
						{ "sWidth": "auto" },
                        { "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/members/sendActivationEmail/','send_emil.png',obj.aData[6],false);}},
						{ "sWidth": "auto" },
                        { "sWidth": "auto" },
                        { "sWidth": "auto" },
                        { "sWidth": "auto" },
                        { "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/members/edit/','edit.gif',obj.aData[11],false);}},
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/members/del/','del.gif',obj.aData[12],true);}}
					 ],
...
<table id="example" width="100%" cellpadding="0" cellspacing="0" class="dataTableGridNJ">
    <thead>
      <tr>
            ...
            <th align="left"><strong>Suburb</strong></th>
