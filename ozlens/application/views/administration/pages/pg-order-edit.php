  ...
  <tr>
   ...
   <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="njtable">
      <tr>
        <th width="206"><strong>Product</strong></th>
        <th width="92">Stock No.</th>
        <th><strong>Rental Period</strong></th>
        <th width="97"><strong>Start Date</strong></th>
        <th width="111"><strong>Return Date</strong></th>
        <th width="278"><strong>Qty</strong></th>
        <th width="78"><strong>Price</strong></th>
        <th width="116">Replacement Value</th>     
      </tr>
      <?PHP 
...
$cart_products = array();
	  ...
	  ?>
       <tr>
        ...
        <td width="93"><?PHP echo $item->rental_days;?></td>
...
<tr>
  ...
  <tr>
    ...
    <select name="order_status" id="order_status">
        ...
        <option value="Returned" <?PHP if($row->order_status=='Returned'){echo "Selected";}?>>Returned</option>
    </select>
    </td>
    <td>
     <p>
