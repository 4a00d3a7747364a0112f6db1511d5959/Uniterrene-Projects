...
<form name="settingsFrm" id="settingsFrm" action="<?php echo base_url(); ?>administration/settings/save" method="post" enctype="multipart/form-data" >  
<?PHP
if($modules)
{
	$i=0;
	foreach($modules as $module)
	{
		...
		?>	  
            ...
            <p>
				...
				{
				?>
                <input type="file" name="<?PHP echo $field->key;?>" id="<?PHP echo $field->key;?>" />
                <br />
                <div style="background:red;padding:5px;width:auto;">
                <img src="<?php echo base_url("uploads/home/".$field->value); ?>" alt="" />
                </div>
                <?PHP } ?>
           </p>
