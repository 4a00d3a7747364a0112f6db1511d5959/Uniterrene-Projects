  ...
  <div class="inner-main-01">
    <div class="txt13 middle-l-f-items-hdng">
      <div class="inner-main-02 txt13">
        <h1 class="txt13">CHECK<span class="txt14"> OUT</span></h1>
      </div>
    </div>
      ...
      <div class="inner-main-07">
        <div class="middle-l-f-items-1 txt15">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="left" valign="top"><?PHP echo $this->load->view('web/includes/checkout');?></td>
            </tr>
            <tr>
      ...
      <div class="inner-main-05-b">
        <div class="inner-main-05-c">
          <form name="billingFrm" id="billingFrm" method="post" action="">
            <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="txt5"><h2 class="txt5"><strong>1 Billing Info </strong></h2></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
            ...
            if($addresses)
            {
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><select name="saved_billing_address" id="saved_billing_address" class="fld-04" onchange="fill_address(this.value);">
            ...
            ?>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><select  name="b_state" type="text" class="fld-04 required" id="b_state">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><input name="b_zip" type="text" class="fld-04 required" id="b_zip" value="<?php
                      if($this->session->userdata('shippingzipcode') != null){ echo $this->session->userdata('shippingzipcode');}
					  ?>" /></td>
                    </tr>
                  </table></td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="txt1">*<strong>Phone Number (inc. Area Code)</strong></td>
                    </tr>
                    <tr>
                      <td height="5"></td>
                    </tr>
                    <tr>
                      <td><input name="b_phone_no" type="text" class="fld-04" id="b_phone_no" />
                        
                        <!--<input name="b_phone_no" type="text" class="fld-04 required phoneAU" id="b_phone_no" />--></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><input name="b_mob_no" type="text" class="fld-04" id="b_mob_no" />
                        ...
                        <!--<input name="b_mob_no" type="text" class="fld-04 required phoneAU" id="b_mob_no" />--></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
        ...
        <div class="inner-main-05-c">
          <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="txt5"><h2 class="txt5"><strong> 2 Shipping Info </strong></h2></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
        ...
        <div class="inner-main-05-c">
          <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="txt5"><h2 class="txt5"><strong> 3 Payment Info </strong></h2></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
