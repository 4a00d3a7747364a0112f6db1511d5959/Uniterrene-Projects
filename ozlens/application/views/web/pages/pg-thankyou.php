...
<div class="middle-main">
  ...
  <div class="inner-main">
	...
	<h1 class="txt13">THANK <span class='txt14'>YOU</span></h1>
    </div>
    ...
    <?php if(isset($order_id)){ ?>
     <div class="middle-l-f-items-1 txt15" id="printable">
	  ...
	  $order = $this->db_model->get_row('orders',array('id'=>$order_id));
		...
		//$cart_items = $this->db_model->sql("select distinct * from {PRE}order_items where order_id = ".$order_id);
		if($cart_items)
		{
		?>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td colspan="2"><table width="95%" border="0" align="center" cellpadding="0">
                      ...
                      <tr>
                        <td><?php echo $order->b_full_name; ?><br />
                          ...
                          Phone: <?php echo $order->b_phone_no; ?><br />
                        ...
                        <td><?php echo $order->s_full_name; ?><br />
                          ...
                          <br /><?php echo $order->s_city; ?>, <?php echo $order->s_state; ?>, <?php echo $order->s_zip; ?><br />
                            Phone: <?php echo $order->s_phone_no; ?><br />
                    ...
                    <table width="95%" border="0" cellspacing="0" cellpadding="3">
					   ...
					   ?>                        
                        <tr>
                          ...
                          <td  align="left"><a class="txt16" href="<?PHP echo $this->product_model->gen_product_url($ci->product_id);?>"><?PHP echo $p_data->product_title;?></a><br/><?php if($p_data->includes != '') echo "<br/><strong>Includes:</strong><br/>".$p_data->includes;?></td>
                    ...
                    <td colspan="2" align="center"><table width="95%" border="0" cellspacing="0" cellpadding="3">
                        <tr>
                         ...
                         <tr>
                            ...
                            <td class="txt19"><?PHP echo $this->config->item('currency_symbol');?>&nbsp;<?PHP echo $this->helper_model->format_currency($order->order_shipping_charges);?></td>
                        </tr>
                        
                         <tr>
                          <td align="left">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td align="right" class="txt19">GST inc :&nbsp;&nbsp;</td>
                          <td class="txt19">
						   <?php 
						 //$total = $this->helper_model->calculate_total($sub_total,$shipping_charges);
						  ...
						  <?PHP echo $this->config->item('currency_symbol')."&nbsp;".$this->helper_model->format_currency($order->order_gst);?></td>
                        </tr>
            ...
            <tr>
              <td align="center" valign="top"><div class="sndmsg-bt-01" id="non-printable"><input type="button" name="button" class="c-here-bt1" value="PRINT" onclick="window.print();" /></div></td>
            </tr>
