...
<div class="middle-main"> 
  ...
  <div class="inner-main-01">
    <div class="txt13 middle-l-f-items-hdng"><h1 class="txt13">CREATE YOUR <span class="txt14">ACCOUNT</span></h1> <span style="font-size:11px;">(Please ensure all details are correct to help us verify your ID)</span></div>
    
     <table cellpadding="3" cellspacing="1" border="0" width="100%">
     	<tr>
        	<td colspan="3" ><div class="inner-fld-01 txt15" style="border-bottom:1px solid #B60F19; width:88%; color:#B60F19;"><h2 class="inner-fld-01 txt15" style="color:#B60F19;"><strong>Personal Information</strong></h2></div></td>
        </tr>
        <tr>
        	<td>
            	<div class="inner-fld-02">
                    ...
                    <div class="inner-fld-01 txt15">
                      <input name="first_name" type="text" class="fld-01 required" id="first_name" value="<?PHP echo stripslashes(set_value('first_name'));?>" />
                    </div>
                  </div>
            </td>
            <td>
            	<div class="inner-fld-02">
                    ...
                    <div class="inner-fld-01 txt15">
                      <input name="middle_name" type="text" class="fld-01" id="middle_name" value="<?PHP echo stripslashes(set_value('middle_name'));?>" />
                    </div>
                  </div>
            </td>
            <td>
            	 <div class="inner-fld-02">
                    ...
                    <div class="inner-fld-01 txt15">
                      <input name="last_name" type="text" class="fld-01 required" id="last_name" value="<?PHP echo stripslashes(set_value('last_name'));?>" />
                    </div>
                  </div>
        ...
        <tr>
            ...
            <td>
            	<div class="inner-fld-02">
                  ...
                  <div class="inner-fld-01 txt15">
                    <input name="passconf" type="password" class="fld-01 required" id="passconf" />
                  </div>
                </div>
            </td>
        </tr>
        <tr>
        	<td colspan="3" ><div class="inner-fld-01 txt15" style="border-bottom:1px solid #B60F19; width:88%; color:#B60F19;"><h2 class="inner-fld-01 txt15" style="color:#B60F19;"><strong>Contact Information</strong></h2></div></td>
        </tr>
        
        <tr>
        	<td>
            	<div class="inner-fld-02">
                  <div class="inner-fld-01 txt15">*<strong>Home Phone (inc Area Code)</strong></div>
                  <div class="inner-fld-01 txt15">
        ...
        <tr>
        	<td colspan="3" ><div class="inner-fld-01 txt15" style="border-bottom:1px solid #B60F19; width:88%; color:#B60F19;"><h2 class="inner-fld-01 txt15" style="color:#B60F19;"><strong>Address</strong></h2></div></td>
        </tr>
        ...
        <tr>
            ...
            <td>
            	 <div class="inner-fld-02">
                  ...
                  <div class="inner-fld-01 txt15">
                    <input name="streetName" type="text" maxlength="33" class="fld-01 required" id="streetName" value="<?PHP echo set_value('streetName');?>" />
                  </div>
                </div>
            </td>
            <td>
                  ...
                  <div class="inner-fld-01 txt15">
                    <input name="streetType" type="text" maxlength="33" class="fld-01 required" id="streetType" value="<?PHP echo set_value('streetType');?>" />
                  </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                  ...
                  <div class="inner-fld-01 txt15">
                    <input name="state" type="text" class="fld-01 required" id="state" value="<?PHP echo set_value('state');?>" />
                  </div>
                </div>
            </td>
        </tr>
    ...
    <div class="middle-l-f-items-1 txt15">
      <input name="news_letter" type="checkbox" id="news_letter" value="Yes" checked="checked" <?php echo set_checkbox('news_letter', 'Yes'); ?> />
 ...
 <script>
	$(function() {
		$( "#dob" ).datepicker({ dateFormat: 'dd-mm-yy',changeYear:true,changeMonth:true,yearRange: '1910:<?=@date('Y')?>',maxDate:new Date() });
	});
</script>
