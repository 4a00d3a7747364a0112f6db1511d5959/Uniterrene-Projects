...
<div class="middle-main"> 
  ...
  <div class="inner-main-01">
    <div class="txt13 middle-l-f-items-hdng">
      <div class="inner-main-02 txt13"><h1 class="txt13">CHECK<span class="txt14"> OUT</span></h1></div>
    </div>
      ...
      <div class="inner-main-05-b">
		...
		?>
          ...
          <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              	<td valign="middle" class="txt5"><h2 class="txt5"><strong>3 Payment Info</strong></h2></td>
            </tr>
            <tr>
            	<td>&nbsp;</td>
            </tr>
