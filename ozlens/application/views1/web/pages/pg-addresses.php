...
<div class="middle-main"> 
  ...
  <div class="inner-main-01">
    <div class="txt13 middle-l-f-items-hdng">ADDRESS <span class="txt14">BOOK</span></div>
    <div class="middle-l-f-items-1 txt15" style="margin-top: 10px;">
      ...
      <div class="inner-main-02" style="width: 100%;">
        ...
        <div class="middle-l-f-items-1 txt14-a">Billing</div>
        <style>
			.orderTable tr td
			{
				height:30px;
      ...
      <!--billinb div end-->
        ...
        <div class="inner-main-02" style="width: 100%; margin-top: 30px;">
            ...
            <div class="middle-l-f-items-1 txt14-a">SHIPPING</div>
