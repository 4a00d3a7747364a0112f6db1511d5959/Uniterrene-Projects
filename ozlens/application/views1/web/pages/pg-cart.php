                        ...
                        <table width="95%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            foreach($cart_items as $ci)
                            {
                                ...
                                <tr>
                                    ...
                                    <td  align="left" class="txt16"><input onKeyUp="calDays(<?PHP echo $i;?>);"  name="rental_days[]" type="text" class="fld-03 required" id="rental_days<?PHP echo $i;?>" value="<?PHP echo $ci->rental_days;?>" /> days</td>
                                    <td  align="left" class="txt16"><input onChange="cal_no_of_days(<?PHP echo $i?>);update_date('start_date',<?PHP echo $i;?>,<?PHP echo $ci->id;?>);" name="start_date[]" type="text" class="fld-04 required date" id="start_date<?PHP echo $i;?>" value="<?PHP echo date('d/m/Y',strtotime($ci->start_date));?>" onmouseover='disable_dates("<?php echo $disableDates; ?>");' onclick='disable_dates("<?php echo $disableDates; ?>");' />
                    ...
                    <td align="center"><table width="95%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                                <td width="28%" align="left" colspan="2">
                                    ...
                                    &nbsp;
                                    <input name="gift_card_code" type="text" class="fld-04" id="gift_card_code" value="" style="width: 150px;" />&nbsp;<span class="txt15"><a class="txt16" id="a2_up" href="#">(?)</a></span>
                                </td>
                                <td align="right" class="txt19">Shipping :&nbsp;&nbsp;</td>
                                <td class="txt19">
									<?php echo $this->config->item('currency_symbol')."&nbsp;".$this->helper_model->format_currency($shipping_charges);?>
								<?PHP //echo $this->config->item('currency_symbol')."&nbsp;".$this->helper_model->calculate_shipping($this->helper_model->calculate_gst($shipping_charges),$shipping_charges);?></td>
                            </tr>
                            <tr>
                                <td align="left">&nbsp;</td>
                                <td>&nbsp;</td>
