...
class Products extends CI_Controller {
	...
	{       
        $data['page_title'] = "Products Managment";
    ...
    {
        $query = "select product_title,slug,stock_no, featured,status, DATE_FORMAT(last_modified, '%a, %M %d, %Y') as date_modified, id as ed, id as dl  from {PRE}products order by id desc";
