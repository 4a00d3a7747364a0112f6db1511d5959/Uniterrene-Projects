...
function initDataTables(){	
 $('#example').dataTable( {
		...
		"aoColumns": [			
						...
						{ "sWidth": "auto" },
						{ "sWidth": "auto" },
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/products/edit/','edit.gif',obj.aData[6],false);}},
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/products/del/','del.gif',obj.aData[7],true);}}
					 ],
