...
<head>
    ...
    <link href="<?PHP echo base_url();?>assets/css/oz.css" rel="stylesheet" type="text/css"/>
  ...
  <div class="top-main">
    <div class="top-1059"> 
      ...
      <div class="top-1">
		...
		{
		?>   
            <a target="_blank" href="<?PHP echo $this->db_model->get_row('settings',array('key'=>'flicker'))->value;?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','<?PHP echo base_url();?>assets/images/flickr-hvr-icn.jpg',1)"><img src="<?PHP echo base_url();?>assets/images/flickr-icn.jpg" name="Image32" width="24" height="23" border="0" id="Image32" /></a>
        <?PHP 
		}
		?>
