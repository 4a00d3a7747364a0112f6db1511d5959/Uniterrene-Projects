...
<div class="txt13 middle-l-f-items-hdng">
    <div class="inner-main-02 txt13">SHOPPING<span class="txt14"> CART</span></div>
                        ...
                        <table width="95%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            foreach($cart_items as $ci)
                            {
                                ...
                                <tr>
                                    ...
                                    <td  align="left" class="txt16"><input onKeyUp="calDays(<?PHP echo $i;?>);" onKeyDown="calDays(<?PHP echo $i;?>);" name="rental_days[]" type="text" class="fld-03 required" id="rental_days<?PHP echo $i;?>" value="<?PHP echo $ci->rental_days;?>" /> days</td>
                                    <td  align="left" class="txt16"><input onChange="cal_no_of_days(<?PHP echo $i?>);" name="start_date[]" type="text" class="fld-04 required date" id="start_date<?PHP echo $i;?>" value="<?PHP echo date('m/d/Y',strtotime($ci->start_date));?>" onmouseover='disable_dates("<?php echo $disableDates; ?>");' onclick='disable_dates("<?php echo $disableDates; ?>");' />
                                    
                                    
                                    
                                    </td>
                                    <td  align="left" class="txt16"><input onChange="cal_no_of_days(<?PHP echo $i?>);" name="return_date[]" type="text" class="fld-04 date" id="return_date<?PHP echo $i;?>" value="<?PHP echo date('m/d/Y',strtotime($ci->return_date));?>" onmouseover='disable_dates("<?php echo $disableDates; ?>");' onclick='disable_dates("<?php echo $disableDates; ?>");'/></td>
                                ...
                                <tr>
                                    <td  align="left">&nbsp;</td>
                                    <td  align="left" class="txt16"><img src="<?PHP echo base_url();?>assets/images/icon_child-44b4f6e2e33de1d8a96f496bc4678a75.png" width="11" height="11" /> <input id="is_waiver<?PHP echo $i;?>" type="checkbox" <?PHP if($ci->w_qty >0){?>checked="checked"<?PHP }?> onClick="update_waiver_qty(<?PHP echo $ci->w_price;?>,<?PHP echo $i;?>);" /><span class="txt15">Waiver Charges&nbsp;<a class="txt16" id="a1_up" href="#">(?)</a></span></td>
                    ...
                    <td align="center"><table width="95%" border="0" cellspacing="0" cellpadding="3">
                            <tr>
                                <td colspan="2" align="left">
                                    <span class="txt16" id="update_cart_err" style="display: none;"> <strong>Please press "Update Cart" to confirm the changes you have made.</strong></span>&nbsp;
                                </td>
                                <td width="18%" align="right" class="txt19">Subtotal :&nbsp;&nbsp;</td>
                                <td width="19%" class="txt19"><?PHP echo $this->config->item('currency_symbol')."&nbsp;".$this->helper_model->format_currency($sub_total);?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="txt19"><?PHP echo $this->config->item('currency_symbol')."&nbsp;".$this->helper_model->calculate_shipping($this->helper_model->calculate_gst($shipping_charges),$shipping_charges);?></td>
                            </tr>
                            <tr>
                                <td align="left">&nbsp;</td>
                                <td>&nbsp;</td>
...
<?PHP }else{?>
    <div style="height:200px;">
        <span class="txt16">No products found in your cart, please use the below link.</span><br/><br/>
        <a href="<?PHP echo base_url();?>" class="txt12">Continue Shopping</a>
    </div>
<?PHP }?>
</div>
</div>
...
<script>
    ...
    function calDays(i) {
        ...
        document.getElementById('return_date'+i+'').value = month +"/"+ date +"/"+ year;
    }
    ...
    function cal_no_of_days(i)
    {
        ...
        var firstDate = new Date(arival_date);
        var secondDate = new Date(return_date);
