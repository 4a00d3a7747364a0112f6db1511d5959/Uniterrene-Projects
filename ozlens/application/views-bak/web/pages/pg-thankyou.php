                    ...
                    <td colspan="2"><table width="95%" border="0" align="center" cellpadding="0">
                      ...
                      <tr>
                        <td><?php echo $order->b_full_name; ?><br />
                          ...
                          <?php echo $order->b_street_address; ?> <?php echo $order->b_apartment_no ; ?> <?php echo $order->b_city; ?> <?php echo $order->b_state; ?>, <?php echo $order->b_zip; ?><br />
                          Phone: <?php echo $order->b_phone_no; ?> Mobile: <?php echo $order->b_mob_no; ?></td>
                        <td><?php echo $order->s_full_name; ?><br />
                          <?php echo $order->s_company_name; ?><br />
                          <?php echo $order->s_street_address; ?> <?php echo $order->s_apartment_no ; ?> <?php echo $order->s_city; ?> <?php echo $order->s_state; ?>, <?php echo $order->s_zip; ?><br />
Phone: <?php echo $order->s_phone_no; ?> Mobile: <?php echo $order->s_mob_no; ?></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <table width="95%" border="0" cellspacing="0" cellpadding="3">
					   ...
					   ?>                        
                        <tr>
                          ...
                          <td  align="left"><?PHP echo $ci->start_date;?></td>
                          <td  align="left"><?PHP echo $ci->return_date;?></td>
                    ...
                    <td colspan="2" align="center"><table width="95%" border="0" cellspacing="0" cellpadding="3">
                        <tr>
                         ...
                         <tr>
                          ...
                          <td class="txt19"><?PHP echo $this->config->item('currency_symbol')."&nbsp;".$this->helper_model->calculate_gst($sub_total);?></td>
                        </tr>
                        <tr>
                            <td align="left">&nbsp;</td>
                            <td>&nbsp;</td>
            ...
            <tr>
              <td align="center" valign="top"><div class="sndmsg-bt-01" id="non-printable"><input type="button" name="button" class="c-here-bt1" value="PRINT INVOICE" onclick="window.print();" /></div></td>
            </tr>
