...
function base_url_wp()
{
    $wp_site_url = get_site_url();
    return str_replace('blog','',$wp_site_url);
}
...
/************** Custome function for getting thumbnail outside wordpress ***********/
...
function ajax_get_thumbnail() {
	...
	//echo file_get_contents($thumb[0]);
	 //echo $thumb[0];
	if($thumb) echo $thumb[0];
