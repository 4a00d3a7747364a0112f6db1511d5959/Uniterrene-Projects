...
$tinybrowser['obfuscate'] = 'K9ckvVx823lodDbFkB11';
...
$tinybrowser['path']['image'] = '/ozlensrental/uploads/tinymce/cms/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/ozlensrental/uploads/tinymce/media/'; // Media files location
$tinybrowser['path']['file']  = '/ozlensrental/uploads/tinymce/files/'; // Other files location
