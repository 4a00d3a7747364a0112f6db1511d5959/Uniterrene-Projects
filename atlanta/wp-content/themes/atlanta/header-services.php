...
<head>
  ...
  <meta name="keywords" content="Eyelash-Extensions,Anti Aging Treatments,Spa Services,Permanent Makeup,Celebrity Makeup Artist">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo esc_url( get_template_directory_uri() )?>/css/edit.css">
...
<!--slider start-->
<section class="inner_page_banner service_inner">
    ...
    <div class="slider_overlay slider_overlay_inner">
      <div class="inner_heading">
        ...
        <ul class="short_cut_link">
          ...
          <li class="short_nav_active"><a href="#"><?php the_title(); ?><sup>TM</sup></a></li>
        </ul>
