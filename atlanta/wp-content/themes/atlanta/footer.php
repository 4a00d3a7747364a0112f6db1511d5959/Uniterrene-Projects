...
<?php wp_footer(); ?>
<script src="http://www.uniterreneprojects.com/dev/atlanta/wp-content/plugins/contact-form-7/includes/js/jquery.form.min.js?ver=3.51.0-2014.06.20"></script>
<script src="http://www.uniterreneprojects.com/dev/atlanta/wp-content/plugins/contact-form-7/includes/js/scripts.js?ver=4.1.1"></script>
...
jQuery(function () {
    ...
    /*jQuery('form').submit(function(event) {
	  ...
	  jQuery('.sign_up input[type=submit] ').attr('value', '');
});
</script>
...
<script type="text/javascript">
    ...
    // var sL = jQuery('.slider .flex-viewport ul li').length;
    // if(sL<=3){
    //   jQuery('.slider').css({'padding-left':'17%'});
    // }else{
    //   jQuery('.slider').css({'padding-left':'0'});
    // }
